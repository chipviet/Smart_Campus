...
public class ShowMapActivity extends AppCompatActivity implements OnMapReadyCallback, MapboxMap.OnMapClickListener, PermissionsListener {
...
// Make a geocoding search with the values inputted into the EditTexts
                        ...
                        Toast.makeText(ShowMapActivity.this, R.string.make_valid_lat, Toast.LENGTH_LONG).show();
                    }
...
// Get the first Feature from the successful geocoding response
                            ...
                            Toast.makeText(ShowMapActivity.this, R.string.no_results,Toast.LENGTH_SHORT).show();
                        }
                    }
    ...
    public void onMapReady(@NonNull final MapboxMap mapboxMap) {
        ...
        mapboxMap.setStyle(getString(R.string.navigation_guidance_day), new Style.OnStyleLoaded() {
            ...
            public void onStyleLoaded(@NonNull Style style) {
                ...
                mapboxMap.addOnMapClickListener(ShowMapActivity.this);
